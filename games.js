...
<head>
    ...
    <style>
        ...
        #game-container { background-color: #fff; border-radius: 20px; padding: 20px; max-width: 600px; margin: 0 auto; box-shadow: 0 4px 8px rgba(0,0,0,0.1); position: relative; min-height: 600px; }
        ...
        #mini-game-screen { display: none; }
        
        /* Приветственный экран */
        #welcome-lily { width: 200px; border-radius: 20px; margin: 20px auto; display: block; }
        
        /* Меню */
        #map-lily { width: 120px; border-radius: 20px; margin: 10px auto; display: block; }
        
        /* Кнопки локаций */
        .location-btn { display: block; width: 80%; margin: 15px auto; padding: 15px; font-size: 20px; background-color: #f0f8ff; border: 2px solid #4CAF50; border-radius: 15px; cursor: pointer; transition: 0.3s; }
        .location-btn:hover { background-color: #dcedc8; transform: scale(1.02); }
        
        /* Игровое поле */
        #top-bar { display: flex; justify-content: space-between; margin-bottom: 20px; }
        .nav-btn { padding: 10px 20px; background-color: #eee; border: none; border-radius: 10px; cursor: pointer; font-weight: bold; }
        
        #lily-img { margin: 20px 0; }
        #lily-img img { width: 150px; border-radius: 20px; }
        
        #xp-bar { background-color: #ddd; border-radius: 10px; height: 20px; width: 100%; margin-bottom: 10px; }
        #xp-fill { background-color: #4caf50; height: 100%; width: 0; border-radius: 10px; transition: width 0.3s; }
        
        #crystal-count { font-size: 20px; margin-bottom: 20px; }
        
        #question-text { font-size: 24px; color: #333; margin-bottom: 20px; }
        #question-image { margin-bottom: 10px; }
        ...
        /* Мини-игры */
        #mini-game-screen h2 { color: #4CAF50; }
        .mini-game-btns { display: flex; justify-content: center; gap: 10px; margin: 15px 0; }
        .mini-game-btn { padding: 15px 20px; font-size: 18px; background-color: #FFC107; border: none; border-radius: 10px; cursor: pointer; font-weight: bold; }
        .mini-game-btn:hover { background-color: #ffb300; }
        
        .pair-game-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 15px; padding: 20px; }
        .pair-card { background-color: #f0f8ff; border: 2px solid #4CAF50; border-radius: 15px; padding: 15px; cursor: pointer; transition: 0.3s; }
        .pair-card:hover { background-color: #dcedc8; }
        .pair-card.matched { background-color: #a5d6a7; border-color: #4caf50; }
        .pair-card img { width: 80px; height: 80px; object-fit: contain; }
        .pair-card .word { font-size: 18px; font-weight: bold; margin-top: 10px; }
        
        #exit-mini-game-btn { padding: 15px 30px; font-size: 20px; background-color: #2196F3; border: none; border-radius: 10px; cursor: pointer; color: white; }
    </style>
</head>
<body>
    <div id="game-container">
        ...
        <div id="welcome-screen">
            ...
            <p>Hi! I'm Lily! Let's go on an adventure!</p>
            <button class="location-btn" onclick="showMap()">Start 🚀</button>
        </div>

        <!-- Экран Карты (Выбор локации) -->
        <div id="map-screen">
            <h1>🗺️ Map</h1>
